...
export const ChapterProgress = memo(function ChapterProgress({
  ...
  return (
    <motion.header
      ...
      className="mb-6 min-w-0 sm:mb-8 md:mb-10"
    >
      <p className="font-serif text-xs tracking-[0.16em] text-text-faint uppercase">
        Chapter {number} of {TOTAL_CHAPTERS}
      </p>
      <p className="text-pretty mt-1.5 break-words font-display text-[clamp(1rem,2vw+0.5rem,1.25rem)] font-light tracking-wide text-text-muted">
        {title}
      </p>
    </motion.header>
  )
